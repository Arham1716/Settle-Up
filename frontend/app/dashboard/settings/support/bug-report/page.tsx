...
export default function BugReportPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("http://localhost:3000/settings/support/bug-report", {
        method: "POST",
        credentials: "include",
      ...
      if (!res.ok) throw new Error(data.message || "Failed to submit bug report");
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 max-w-2xl mx-auto">
        ...
        {success ? (
          <div className="bg-green-600/20 border border-green-600 rounded-lg p-6 text-center">
            <p className="text-green-400 font-medium">Bug report submitted successfully!</p>
          ...
          <form onSubmit={handleSubmit} className="bg-black/40 rounded-lg p-6 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={8}
                maxLength={2000}
                placeholder="Describe the bug, steps to reproduce, and what you expected to happen..."
